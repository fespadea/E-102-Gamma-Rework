...
if (!(state == PS_ATTACK_GROUND || state == PS_ATTACK_AIR) || (!(attack == AT_UAIR && window > 1 && window < get_attack_value( AT_UAIR, AG_NUM_WINDOWS)) && !(attack == AT_DSTRONG && window < get_attack_value(AT_DSTRONG, AG_NUM_WINDOWS) && window > 2) && attack != AT_FSTRONG && !(attack == AT_DAIR && window == get_attack_value( AT_DAIR, AG_NUM_WINDOWS)-1))){
