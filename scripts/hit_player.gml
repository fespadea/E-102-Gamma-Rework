...
var dstrongException = my_hitboxID.attack == AT_DSTRONG && my_hitboxID.hbox_num < 7;
...
if(dattackException || uairException || dstrongException || dairException || jabException || ftiltException){
...
if(my_hitboxID.attack == AT_NSPECIAL){
    if(my_hitboxID.hbox_num == 4){
        ...
        var windboxAngle = 0;
        with hit_player_obj {
            windboxAngle = get_hitbox_angle(other.my_hitboxID);
        }
