...
set_window_value(AT_JAB, 1, AG_WINDOW_LENGTH, 25);
set_window_value(AT_JAB, 1, AG_WINDOW_ANIM_FRAMES, 10);
set_window_value(AT_JAB, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_JAB, 1, AG_WINDOW_SFX, asset_get("sfx_swipe_weak1"));
set_window_value(AT_JAB, 1, AG_WINDOW_SFX_FRAME, 15);
...
set_window_value(AT_JAB, 3, AG_WINDOW_SFX_FRAME, 10);
...
set_hitbox_value(AT_JAB, 1, HG_WINDOW_CREATION_FRAME, 20);
