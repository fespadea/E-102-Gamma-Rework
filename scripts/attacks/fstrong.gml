...
// set_window_value(AT_FSTRONG, 3, AG_WINDOW_SFX, sound_get("GammaElectricity"));
...
set_window_value(AT_FSTRONG, 4, AG_WINDOW_SFX, sound_get("GammaBlast"));

set_window_value(AT_FSTRONG, 5, AG_WINDOW_LENGTH, 45);
set_window_value(AT_FSTRONG, 5, AG_WINDOW_ANIM_FRAMES, 9);
