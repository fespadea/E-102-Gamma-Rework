...
set_window_value(AT_USTRONG_2, 2, AG_WINDOW_LENGTH, 30);
set_window_value(AT_USTRONG_2, 2, AG_WINDOW_ANIM_FRAMES, 10);
set_window_value(AT_USTRONG_2, 2, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_USTRONG_2, 2, AG_WINDOW_SFX, asset_get("sfx_absa_whip3"));
set_window_value(AT_USTRONG_2, 2, AG_WINDOW_SFX_FRAME, 1);
set_window_value(AT_USTRONG_2, 2, AG_WINDOW_ANIM_FRAME_START, 1);
set_window_value(AT_USTRONG_2, 2, AG_WINDOW_HAS_WHIFFLAG, 10);
...
set_window_value(AT_USTRONG_2, 3, AG_WINDOW_ANIM_FRAME_START, 0);
set_window_value(AT_USTRONG_2, 3, AG_WINDOW_HAS_WHIFFLAG, 30);
