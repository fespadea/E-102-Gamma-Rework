...
set_window_value(AT_FSTRONG_2, 2, AG_WINDOW_SFX, asset_get("sfx_abyss_explosion_big"));
set_window_value(AT_FSTRONG_2, 2, AG_WINDOW_HAS_WHIFFLAG, 10);
...
set_window_value(AT_FSTRONG_2, 3, AG_WINDOW_HAS_SFX, 0);
...
set_hitbox_value(AT_FSTRONG_2, 1, HG_LIFETIME, 11);
...
set_hitbox_value(AT_FSTRONG_2, 2, HG_WINDOW_CREATION_FRAME, 9);
