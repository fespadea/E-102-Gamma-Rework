...
// set_window_value(AT_USTRONG, 3, AG_WINDOW_SFX, sound_get("GammaElectricity"));
...
set_window_value(AT_USTRONG, 8, AG_WINDOW_LENGTH, 2);
set_window_value(AT_USTRONG, 8, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_USTRONG, 8, AG_WINDOW_ANIM_FRAME_START, 14);

set_window_value(AT_USTRONG, 9, AG_WINDOW_LENGTH, 4);
set_window_value(AT_USTRONG, 9, AG_WINDOW_ANIM_FRAMES, 4);
set_window_value(AT_USTRONG, 9, AG_WINDOW_ANIM_FRAME_START, 16);

set_window_value(AT_USTRONG, 10, AG_WINDOW_LENGTH, 27);
set_window_value(AT_USTRONG, 10, AG_WINDOW_ANIM_FRAMES, 9);
set_window_value(AT_USTRONG, 10, AG_WINDOW_ANIM_FRAME_START, 20);
set_window_value(AT_USTRONG, 10, AG_WINDOW_HAS_WHIFFLAG, true);
...
set_hitbox_value(AT_USTRONG, 6, HG_WINDOW, 8);
...
set_hitbox_value(AT_USTRONG, 7, HG_WINDOW, 9);
