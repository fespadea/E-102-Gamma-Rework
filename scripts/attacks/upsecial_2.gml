...
set_attack_value(AT_USPECIAL_2, AG_LANDING_LAG, 5);

set_window_value(AT_USPECIAL_2, 1, AG_WINDOW_LENGTH, 28);
set_window_value(AT_USPECIAL_2, 1, AG_WINDOW_ANIM_FRAMES, 6);
set_window_value(AT_USPECIAL_2, 1, AG_WINDOW_ANIM_FRAME_START, 1);
set_window_value(AT_USPECIAL_2, 1, AG_WINDOW_CUSTOM_GRAVITY, 0.082);
set_window_value(AT_USPECIAL_2, 1, AG_WINDOW_TYPE, 9);